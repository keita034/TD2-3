...
bool AliceFileStream::LoadAlicePolygonData(const std::string& path, AliceModel* model)
{
	//モデルデータ
...
void AliceFileStream::ReadModelData(std::stringstream& data, std::string& str, AliceModel* model)
{
	//1行分の文字列を入れる変数
	std::string line;
...
void AliceFileStream::ReadMeshsData(std::stringstream& data, std::string& str, AliceModel* model)
{
	//1行分の文字列を入れる変数
	std::string line;
...
void AliceFileStream::ReadHesderData(std::stringstream& data, std::string& str, AliceModel* model)
{
	//1行分の文字列を入れる変数
	std::string line;
...
void AliceFileStream::ReadNodesData(std::stringstream& data, std::string& str, AliceModel* model)
{
	//1行分の文字列を入れる変数
	std::string line;
...
void AliceFileStream::ReadNodeData(std::stringstream& data, std::string& str, Node& node, AliceModel* model)
{
	//1行分の文字列を入れる変数
	std::string line;
...
bool AliceFileStream::LoadAlicePolygonBinaryData(const std::string& path, AliceModel* model)
{
	//ファイルを開く
	FILE* fp = NULL;
...
bool AliceFileStream::ReadHesderBinaryData(AliceModel* model, FILE* fp)
{
	//名前
	{
		size_t nameNum;
...
bool AliceFileStream::ReadNodesBinaryData(AliceModel* model, FILE* fp)
{
...
bool AliceFileStream::ReadMeshBinaryData(AliceModel* model, FILE* fp)
{
	for (size_t i = 0; i < model->meshes.size(); i++)
	{
...
bool AliceFileStream::LoadAliceMotionBinaryData(const std::string& path, AliceMotionData* motion)
{
	//ファイルを開く
	FILE* fp = NULL;
	fopen_s(&fp, path.data(), "rb");
